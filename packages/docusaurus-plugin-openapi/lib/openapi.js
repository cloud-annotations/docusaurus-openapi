    ...
    return Object.entries(spec.paths)
        ...
        return entries.map(([key, val]) => {
            ...
            if (isOperationObject(val)) {
                ...
                const summary = (_b = (_a = operationObject.summary) !== null && _a !== void 0 ? _a : operationObject.operationId) !== null && _b !== void 0 ? _b : "Missing summary";
                if (operationObject.description === undefined) {
                    operationObject.description = (_d = (_c = operationObject.summary) !== null && _c !== void 0 ? _c : operationObject.operationId) !== null && _d !== void 0 ? _d : "";
                }
